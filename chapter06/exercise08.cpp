/*
	[8] The grammar in §6.6.4 is incomplete (we did warn you against overreliance on comments);
	it does not define sequences of statements, such as 4+4; 5−6;, and it does not incorporate
	the grammar changes outlined in §6.8. Fix that grammar. Also add whatever you feel is needed
