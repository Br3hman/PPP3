/*
	...
	You might find the standard-library function isspace(ch), which returns true if
	ch is a whitespace character, useful.

	[6] Part of what every program should do is to provide some way of helping its user.
	Have the calculator print out some instructions for how to use the calculator if the
	user presses the H key (both upper- and lowercase).
